			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+8801558259678</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:jannatflowers3@gmail.com">info@sprezzaturabd.com</a></div>
								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li> <a href="#">Shirts<i class="fas fa-chevron-down"></i></a>
                                                <ul>
													<li><a href="#">DRESS SHIRT<i class="fas fa-chevron-down"></i></a></li>
													<li><a href="#">OVERSHIRT<i class="fas fa-chevron-down"></i></a></li>
													<li><a href="#"> CHAMBRAY SHIRT<i class="fas fa-chevron-down"></i></a></li>
													<li><a href="#">SLEEVE T-SHIRT<i class="fas fa-chevron-down"></i></a></li>
													<li><a href="#">   POLO SHIRTT<i class="fas fa-chevron-down"></i></a></li>

                                                </ul>
                                            </li>
											<li>  <a href="#">Trousers/Pants<i class="fas fa-chevron-down"></i></a>

                                                <ul>
													<li><a href="#">Causal Trousers<i class="fas fa-chevron-down"></i></a></li>
													<li><a href="#">CORDUROY TROUSERS/Pants<i class="fas fa-chevron-down"></i></a></li>
													<li><a href="#">WOOL TROUSERS<i class="fas fa-chevron-down"></i></a></li>
												</ul>
                                            </li>

											<li><a href="#">Jackets<i class="fas fa-chevron-down"></i></a></li>
										</ul>
									</li>
									<li class="hassubs">
...
<div class="videobanner">
    {{-- <div class="container-fluid">
        <div class="row">
            <div class="col">
    <iframe width="100%" height="650" src="https://www.youtube.com/embed/1SPmOKhWNg0?si=Iany-jmNDxlNCHyl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
        </div>
    </div> --}}
    <iframe width="100%" height="650"  src="https://www.youtube.com/embed/1SPmOKhWNg0?si=Iany-jmNDxlNCHyl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
	...
	<div class="banner">
		...
		<div class="container-fluid fill_height">
			<div class="row fill_height">
				<div class="banner_product_image"><img src="{{ asset('/frontendimages/banner_product.png')}}" alt=""></div>
